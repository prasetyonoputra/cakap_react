            ...
            <header className='d-flex justify-content-center align-items-center'>
                <div className="row">
                    <div className="col-auto d-flex align-items-center">
                        <div classNameName='me-2'>
                            <img width="50" height="50" src="./assets/images/default-logo.png" alt="Profile Logo" className="rounded-circle" />
                        </div>
                    ...
                    <div className="col d-flex align-items-center">
                        <button type="button" className="btn dropdown-toggle dropdown-toggle-split border-0"
